  ...
  try {
    ...
    const sampleRawItems = [
      // AI Tools
      {
        ...
        title: 'Engrim – Local SQLite Memory Engine for AI CLIs',
        description: 'A universal, local-first SQLite memory engine for AI CLI tools with fast vector retrieval.',
        summary: 'Local-first persistent context engine providing SQLite-backed recall for terminal AI agents.',
        url: 'https://github.com/timgordontg/engrim',
        category: 'AI Infrastructure',
        tags: ['ai', 'sqlite', 'memory-engine', 'cli'],
        score: {
          total: 96,
          freshness: 24,
          popularity: 24,
          developerValue: 25,
          technologyImpact: 23,
          reasons: ['High developer utility', 'Zero external cloud dependency'],
        },
        tool: {
          pricingModel: 'OPEN_SOURCE' as const,
          hasApi: true,
          isOpenSource: true,
          githubUrl: 'https://github.com/timgordontg/engrim',
        },
      },
      {
        type: 'AI_TOOL' as const,
      ...
      // Developer Jobs
      {
        ...
        description: 'Build and scale the core Referential Data Platform graph engine tracking infrastructure dependencies.',
        summary: 'Core distributed systems engineering role scaling high-throughput graph queries at Datadog.',
        url: 'https://www.arbeitnow.com/jobs/companies/datadog/remote-senior-software-engineer-redapl-graph-engine-264102',
        category: 'Careers',
        tags: ['distributed-systems', 'graph-engine', 'go', 'rust'],
        score: {
          total: 94,
          freshness: 24,
          popularity: 22,
          developerValue: 24,
          technologyImpact: 24,
          reasons: ['Tier-1 observability infrastructure', 'High-scale distributed systems'],
        },
        job: {
          company: 'Datadog',
          ...
          skills: ['Go', 'Rust', 'Graph Databases', 'Distributed Systems'],
        },
      },
      {
        type: 'JOB' as const,
        title: 'Software QA Engineer II',
        description: 'Develop automated test harnesses for public safety and connected camera cloud infrastructure.',
        summary: 'Lead QA automation initiatives across cloud microservices and mission-critical devices.',
        url: 'https://www.arbeitnow.com/jobs/companies/axon/software-qa-engineer-ii-kassel-hesse-167685',
        category: 'Careers',
        tags: ['qa', 'automation', 'cloud', 'testing'],
        score: {
          total: 91,
          freshness: 22,
          popularity: 22,
          developerValue: 24,
          technologyImpact: 23,
          reasons: ['High reliability engineering', 'Public safety IoT scale'],
        },
        job: {
          company: 'Axon',
          location: 'Kassel / Remote',
          remote: true,
          employmentType: 'FULL_TIME',
          skills: ['QA Automation', 'Python', 'Docker', 'CI/CD'],
        },
      },
