      ...
      <div className="border-b border-border pb-5">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 font-mono text-xs text-muted">
            <span className="rounded border border-border bg-card px-3 py-1.5 font-bold text-accent">
          ...
          {systemServices.map((svc) => (
            <div key={svc.name} className="rounded-xl border border-border bg-card p-4">
              <div className="flex items-center justify-between">
                <span className="font-mono text-xs text-foreground font-bold">{svc.name}</span>
                <span className="h-2 w-2 rounded-full bg-accent" />
              </div>
              <p className="font-mono text-[11px] text-muted/60 mt-0.5">{svc.desc}</p>
      ...
      <section className="space-y-3">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          <div className="rounded-xl border border-border bg-card p-4">
            <span className="text-[10px] font-mono text-muted/60 uppercase">Run Status</span>
            <div className="font-mono text-xl font-bold text-accent mt-1">{lastRunStatus}</div>
            <span className="text-[10px] font-mono text-muted/60">Autonomous commit</span>
          </div>

          <div className="rounded-xl border border-border bg-card p-4">
            <span className="text-[10px] font-mono text-muted/60 uppercase">Quality Index</span>
            <div className="font-mono text-xl font-bold text-foreground mt-1">{quality}%</div>
            <span className="text-[10px] font-mono text-muted/60">Schema validated</span>
          </div>

          <div className="rounded-xl border border-border bg-card p-4">
            <span className="text-[10px] font-mono text-muted/60 uppercase">Compute Time</span>
            <div className="font-mono text-xl font-bold text-foreground mt-1">{duration}s</div>
            <span className="text-[10px] font-mono text-muted/60">GitHub Actions</span>
          </div>

          <div className="rounded-xl border border-border bg-card p-4">
            <span className="text-[10px] font-mono text-muted/60 uppercase">Commit Gate</span>
            <div className="font-mono text-xl font-bold text-foreground mt-1">{commitSha}</div>
            <span className="text-[10px] font-mono text-muted/60">Meaningful changes</span>
          </div>
        </div>
      </section>
    </div>
